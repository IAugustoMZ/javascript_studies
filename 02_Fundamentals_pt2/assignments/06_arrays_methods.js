...
// defining the array neighbours
const neighbours = ['Venezuela', 'Colombia', 'Bolivia'];

console.log(neighbours);

// adding 'Utopia' to the end of the array
neighbours.push('Utopia');

console.log(neighbours);

// removing 'Utopia' from the end of the array
neighbours.pop();

console.log(neighbours);

// checking if the array includes 'Germany'
if (!neighbours.includes('Germany')) {
  console.log('Probably not a central european country :D');
}

// changing the name of a neighbouring country
indexColombia = neighbours.indexOf('Colombia');
neighbours[indexColombia] = 'Republic of Colombia';
