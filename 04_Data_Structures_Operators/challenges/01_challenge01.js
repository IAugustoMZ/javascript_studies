...
Suppose we get data from a web service about a certain game ('game' variable in the code below). In this challenge we're gonna work with that data. So, here are your tasks:
